...
<title>목록 - 뉴스 - Media - PACIFICLINKS</title>
...
<script type="text/javaScript" defer="defer">
	...
	function fn_addView() {
	   	...
	   	document.boardNttListForm.boardNo.value = "news";
	   	document.boardNttListForm.submit();		
	}
...
<body>
	...
	<section id="contents" class="container" tabindex="-1">
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<ul class="list">
				<li class="subject"><a href="/selectBoardView.do?boardNo=${result.boardNo}&contentNo=${result.contentNo}">${result.title}</a></li>
