...
<title>목록 - 프로모션 - Media - PACIFICLINKS</title>
...
<body>
	...
	<div class="top-visual media">
		
		<div class="container">
		
			<div class="wrap">
				<h2><em>PACIFICLINKS</em>media</h2>
	...
	.video-container embed {
	    ...
	    left: 0; 
                    ...
                    <c:if test="${boardNttResult.linkUrl1 ne '' && boardNttResult.linkUrl1 ne null}">
	                    <div>
	                        <div>		                           
                           	 	<div class="video-container"><!-- 실제 아래 나오는 부분 -->
								    <iframe width="500" height="400" src="${fn:replace(boardNttResult.linkUrl1,'youtu.be','youtube.com/embed')}" frameborder="0"></iframe>
								</div>
							</div>
		                           <!-- 
		                           <p>제주 테디밸리 전경</p>
                    ...
                    <c:if test="${boardNttResult.linkUrl2 ne '' && boardNttResult.linkUrl2 ne null}">
	                    <div>
		                        ...
		                        <div>
		                          	<div class="video-container"><!-- 실제 아래 나오는 부분 -->
								    	<iframe width="500" height="400" src="${fn:replace(boardNttResult.linkUrl2,'youtu.be','youtube.com/embed')}" frameborder="0"></iframe>
									</div>
								</div>
		                           <!-- 
		                           <p>제주 테디밸리 전경</p>
                    ...
                    <c:if test="${boardNttResult.linkUrl3 ne '' && boardNttResult.linkUrl3 ne null}">
	                    <div>
		                        ...
		                        <div>
		                           <div class="video-container"><!-- 실제 아래 나오는 부분 -->
								    	<iframe width="500" height="400" src="${fn:replace(boardNttResult.linkUrl3,'youtu.be','youtube.com/embed')}" frameborder="0"></iframe>
									</div>
								</div>
		                           <!-- 
		                           <p>제주 테디밸리 전경</p>
                    ...
                    <c:if test="${boardNttResult.linkUrl4 ne '' && boardNttResult.linkUrl4 ne null}">
	                    <div>
		                        ...
		                        <div>
		                           <div class="video-container"><!-- 실제 아래 나오는 부분 -->
								    	<iframe width="500" height="400" src="${fn:replace(boardNttResult.linkUrl4,'youtu.be','youtube.com/embed')}" frameborder="0"></iframe>
									</div>
								</div>
		                           <!-- 
		                           <p>제주 테디밸리 전경</p>
                    ...
                    <c:if test="${boardNttResult.linkUrl5 ne '' && boardNttResult.linkUrl5 ne null}">
	                    <div>
		                        ...
		                        <div>
		                           <div class="video-container"><!-- 실제 아래 나오는 부분 -->
								    	<iframe width="500" height="400" src="${fn:replace(boardNttResult.linkUrl5,'youtu.be','youtube.com/embed')}" frameborder="0"></iframe>
									</div>
								</div>
		                           <!-- 
		                           <p>제주 테디밸리 전경</p>
  			...
  			<c:if test="${!(empty boardAtchmnflImgList)}">
            <div class="photo">
                <p class="key">관련 포토</p>
                <div class="wrap">
                    <ul>
                    <c:forEach var="boardAtchmnflImg" items="${boardAtchmnflImgList}" varStatus="idx">
                        <li>
                            <a href="${boardAtchmnflImg.storePath}/${boardAtchmnflImg.storeFileNm}" target="_blank">
                                <div class="image"><img src="${boardAtchmnflImg.storePath}/thumb/t_${boardAtchmnflImg.storeFileNm}" width="100%"  alt=""/></div>
                                <p>${boardAtchmnflImg.replcText}</p>
                            </a>
                        </li>
                     </c:forEach>   
                    </ul>
			...
			<div class="board-view-con">				
				<p class="mt40">${boardNttResult.content}</p>
			</div>
			<!-- 
			<div class="bottom">
				<ul class="prev">
