...
<form action="/pl/updateHire.do" method="post" name="bbsNttUpdateForm" id="bbsNttUpdateForm" onsubmit="return validateBoardRegist(this)" enctype="multipart/form-data">
...
<input type="hidden" id="contentNo" name="contentNo" value="${boardNttResult.contentNo}" />
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div class="input-group">
							...
							<input type="text" class="form-control" data-mask="" placeholder="" id="title" name="title" style="width:1000px;" value="${boardNttResult.title}"/>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5" id="f1">
						...
						<c:if test="${hireVOList.hireType eq 'a1'}">
							<div>							
								<input type="text" class="form-control" data-mask="" placeholder="" id="${hireVOList.hireType}_1" name="${hireVOList.hireType}" style="width:1000px;" value="${hireVOList.hireData}"/>	
	...
	<div style="padding-top:50px; padding-bottom:10px; text-align:right">
		...
		<a href="/pl/mngHireList.do?boardNo=${boardNo}"><button type="button" class="btn btn-default" style="width:80px">목록</button></a>
	</div>
