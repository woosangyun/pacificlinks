...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	function goPage(pageNo) {
		...
		document.boardNttListForm.action = "<c:url value='/pl/mngHireList.do'/>";
	   	document.boardNttListForm.submit();
	}
	function fn_addView() {
	   	document.boardNttListForm.action = "<c:url value='/pl/addHireView.do'/>";
		...
		<tbody>
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<tr>
					...
					<td align="center"><a href="/pl/mngHireView.do?boardNo=${result.boardNo}&contentNo=${result.contentNo}"><c:out value="${result.title}"/></a></td>
